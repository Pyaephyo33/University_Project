							...
							<table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<?php echo '<a class="btn btn-icon btn-sm" href="QaMDepartmentEdit.php?DepartmentID='. $row->DepartmentID.'"><i class="fa fa-edit"></i></a>';?>
                                                
                                                <?php echo '<a class="btn btn-icon btn-sm js-sweetalert" onclick="return confirm(\'Confirm Delete?\')" href="QaMDepartmentDelete.php?DepartmentID='. $row->DepartmentID.'"><i class="fa fa-trash-o text-danger"></i></a>';?>
                                            </td>
                                        </tr>
                                        <?php } ?>
