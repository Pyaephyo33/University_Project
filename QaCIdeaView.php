...
if (isset($_POST['add'])) 
    {
        ...
        if (move_uploaded_file($file, $destination)) {
            ...
            if (mysqli_query($connect,$add)) {
                ...
                echo "<script>window.location='QaCClosureDate.php'</script>";
            }
        } else {
...
<body class="ttr-opened-sidebar ttr-pinned-sidebar">
    ...
    <!-- header start -->
    <?php 
        include("QaCHeader.php");
     ?>
    <!-- header end -->
    <!-- Left sidebar menu start -->
    <?php 
        include("QaCSidebar.php");
     ?>
...
<div><br>
    &nbsp<a href="QaCIdeaView.php?ClosureID=<?php echo $ClosureID;?>" class="btn">Most View</a>&nbsp&nbsp
    <a href="QaCIdeaLatest.php?ClosureID=<?php echo $ClosureID;?>" class="btn">New-Old Ideas</a>
</div><br>
                            ...
                            <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo '<a class="btn btn-icon btn-sm" href="IdeaDetails.php?IdeaID='. $row1->IdeaID.'"><i class="fa fa-comments-o"></i></a>';?></td>                                        </tr>
                                        <?php } ?>
                                        
                                    </tbody>
                                </table>
                                <ul class="pagination">
        <li><a href="QaCIdeaList.php?ClosureID=<?php echo $ClosureID;?>&pageno=1">First</a></li>        
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo 'QaCIdeaList.php?ClosureID='.$ClosureID.'&pageno='.($pageno - 1);}?>">Prev</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo 'QaCIdeaList.php?ClosureID='.$ClosureID.'&pageno='.($pageno + 1); } ?>">Next</a>
        </li>
        <li><a href="QaCIdeaList.php?ClosureID=<?php echo $ClosureID;?>&pageno=<?php echo $total_pages; ?>">Last</a></li>
    </ul>
                        </div>
