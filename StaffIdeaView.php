...
if (isset($_POST['add'])) 
    {
        ...
        if (move_uploaded_file($file, $destination)) {
            ...
            if (mysqli_query($connect,$add)) {
                ...
                echo "<script>window.location='StaffClosureDate.php'</script>";
            }
        } else {
...
<div><br>
    &nbsp<a href="StaffIdeaView.php?ClosureID=<?php echo $ClosureID;?>" class="btn">Most View</a>&nbsp&nbsp
    <a href="StaffIdeaLatest.php?ClosureID=<?php echo $ClosureID;?>" class="btn">New-Old Ideas</a>
</div><br>
                        <div class="widget-inner-a">
                            <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                ...
                                <ul class="pagination">
        <li><a href="StaffIdeaList.php?ClosureID=<?php echo $ClosureID;?>&pageno=1">First</a></li>        
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo 'StaffIdeaList.php?ClosureID='.$ClosureID.'&pageno='.($pageno - 1);}?>">Prev</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo 'StaffIdeaList.php?ClosureID='.$ClosureID.'&pageno='.($pageno + 1); } ?>">Next</a>
        </li>
        <li><a href="StaffIdeaList.php?ClosureID=<?php echo $ClosureID;?>&pageno=<?php echo $total_pages; ?>">Last</a></li>
    </ul>
                        </div>
