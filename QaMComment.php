						...
						<!--<div class="wc-title">
							...
							<form class="edit-profile m-b30" action="" method="POST">
								...
								<div class="form-group row">
									...
									<div class="form-group row">
										<div class="col-sm-7">
											<a class="btn" href="QaMComment.php?IdeaID=<?php echo $IdeaID;?>"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 0</a>
 											<a class="btn" href="QaMComment.php?IdeaID=<?php echo $IdeaID;?>"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i> 0</a>
										</div>
									</div>
									<div>
...
<input type="text" name="feedback">
										...
										<div class="col-sm-7"><br>
											<a href="QaMCommentView.php?IdeaID=<?php echo $IdeaID;?>" class="btn">New-Old Feedback</a>
